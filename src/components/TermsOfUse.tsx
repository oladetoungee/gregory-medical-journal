  ...
  return (
    <div className="mt-12 py-12 px-6 sm:px-12 lg:px-12 bg-white">
      <div className="container mx-auto space-y-8">
        <Typewriter text="Terms of Use" className="page-header" />
        <p className="md:text-base tex-sm text-sec">
          By using Gregory Medical Journal's website, you agree to comply with
          these terms of use. Please read them carefully before accessing our
          services.
        </p>
        {terms.map((term) => (
